...
public class Aktivitem extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aktivitem);
        ...
        if (myBluetoothAdapter == null) {
            ...
            discoverableBtn.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(Aktivitem.this, deviceDiscoverable.class));
                }
            });
            ...
            findBtn.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(Aktivitem.this, findActivity.class));
                }
            });
